...
public partial class Machine4_default : System.Web.UI.Page
{
    ...
    protected void Button_submit_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            conn.Open();
            string insertQuery = "INSERT INTO Machine4table (system_datetime, date, time, operator_name, checkedby_name, P_suction, P_Discharge, P_Oil, DP_Oil_Differential_Oil_Pressure, Crank_Case_Pressure, T_Suction, T_Discharge, T_Oil, T_Oil_Seperator, Suction_Superheat, Ref_High_Level, Ref_Low_Level, RPM_of_the_Motor, Motor_Amp, Capacity, Run_Hrs, Chilled_Water_Inlet_Temperature, Chilled_Water_Outlet_Temperature, Condenser_Water_Inet_Temperature, Condenser_Water_Outlet_Temperature, Cold_Well_Manual_Gauge_Temp_Reading, Ammonia_Status_In_Sight_Glass_Clear_And_Free_Of_Bubble, Compressor_oil_Level_Between_1_2_And_3_4, Chiller_Operating_Condition, Chill_Water_Tank_Level_Hot_Well_Side, Chill_Water_Tank_Level_Cold_Well_Side, Cooling_Tower_Chemical_Add_3DT177, Cooling_Tower_Chemical_Add_3DT104, Cooling_Tower_Chemical_Add_ST70, Cooling_Tower_Chemical_Add_NALCO_7348, Cooling_Tower_Chemical_Add_NALCO_7330, Cold_Well_Delivery_Pump_Pressure, Wet_Bulb_Temperature, Dry_Bulb_Temperature, Any_Leaks_From_Running_Pump, Any_abnormal_noise_or_Vibration, Cooling_Tower_Circulation_Pump_Pressure, Any_Leaks_From_Running_Pump_2, Any_Abnormal_Noise_Or_Vibration_2, C_Tower_Make_Up_Water_Line_Ball_Float_Valve_Function) VALUES (@system_datetime, @date, @time, @operator_name, @checkedby_name, @data1, @data2, @data3, @data4, @data5, @data6, @data7, @data8, @data9, @data10, @data11, @data12, @data13, @data14, @data15, @data16, @data17, @data18, @data19, @data20, @data21, @data22, @data23, @data24, @data25, @data26, @data27, @data28, @data29, @data30, @data31, @data32, @data33, @data34, @data35, @data36, @data37, @data38, @data39, @data40)";
            ...
            com.Parameters.AddWithValue("@data39", data39.Text);
            com.Parameters.AddWithValue("@data40", data40.Text);
