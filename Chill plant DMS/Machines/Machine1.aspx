<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Machine1.aspx.cs" Inherits="Machine1_default" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div id="header" style="background-color: #b3dcf6">
            ...
            <hr>
                <h3 style="color: #044b98; padding:20px;border-bottom-style:solid; border-top-style:solid; border-width: 2px" class="text-center"> Machine 1 Add a data</h3>
            <hr>
            <strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Machine 1 - GEA CHILL PLANT - 20C<br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Nominal capacity - 21 TR</strong></p>
