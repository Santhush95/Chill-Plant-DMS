<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Machine3.aspx.cs" Inherits="Machine3_default" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div id="header" style="background-color: #b3dcf6">
            ...
            <hr>
                <h3 style="color: #044b98; padding:20px;border-bottom-style:solid; border-top-style:solid; border-width: 2px" class="text-center"> Machine 3 Add a data</h3>
            <hr>
            <strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Machine 3 - GEA GRASSO +5C CHILL PLANT<br />
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Nominal capacity - 250 TR</strong></p>
        <table class="auto-style1">
            ...
            <tr>
                <td class="auto-style54">&nbsp;</td>
                <td class="auto-style55">Motor Amp</td>
                <td class="auto-style55">
            ...
            <tr>
                <td class="auto-style54">&nbsp;</td>
                <td class="auto-style55">Ammonia_Status_In_Sight_Glass_Clear_And_Free_Of_Bubbles</td>
                <td class="auto-style55">
                    <asp:TextBox ID="data19" runat="server" class="form-control"></asp:TextBox>
                </td>
                <td class="auto-style55"></td>
                <td class="auto-style55">Chill_Operating_Condition</td>
                <td class="auto-style55">
            ...
            <tr>
                <td class="auto-style56">&nbsp;</td>
                <td class="auto-style57">Cooling_Tower_Chemical_Add_NALCO_7348_2</td>
                <td class="auto-style57">
            ...
            <tr>
                <td class="auto-style56"></td>
                <td class="auto-style57">Stand_By_Pumps_Suction_Filter_Condition_Clean_or_Not</td>
                <td class="auto-style57">
